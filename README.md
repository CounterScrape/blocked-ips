...
## 📊 Live Metrics
* **Total Unique IPs Blocked:** `1091`
* **Total Bandwidth Consumed:** `15367 MB` (~15.01 GB)
...
| :--- | :---: | :--- | :--- | :---: | :---: |
| `213.209.159.115` | DE | Feo Prest SRL | `DATABASE_SCANNER` | 17932 | 0.0 MB |
| `213.209.159.154` | DE | Feo Prest SRL | `DATABASE_SCANNER` | 2546 | 0.0 MB |
| `2a06:98c0:3600::103` | US | Cloudflare, Inc. | `EXPLOIT_SCANNER` | 2113 | 86.02 MB |
...
| `155.2.228.196` | CH | iway AG | `HONEYTOKEN_HIT` | 652 | 0.0 MB |
...
| `::ffff:45.148.10.200` | NL | Techoff SRV Limited | `EXPLOIT_SCANNER` | 163 | 0.0 MB |
...
| `152.42.241.61` | SG | DigitalOcean, LLC | `DATABASE_SCANNER` | 101 | 0.0 MB |
...
| `unknown` | ?? | unknown | `DATABASE_SCANNER` | 91 | 0.0 MB |
...
| `185.242.177.67` | AT | Blue Shield Security GmbH | `HONEYTOKEN_HIT` | 56 | 0.0 MB |
| `121.29.51.109` | CN |  | `HONEYTOKEN_HIT` | 54 | 0.02 MB |
| `203.159.90.218` | NL | 1337 Services GmbH | `HONEYTOKEN_HIT` | 50 | 193.94 MB |
| `45.148.10.200` | NL | Techoff SRV Limited | `EXPLOIT_SCANNER` | 48 | 0.0 MB |
| `::ffff:148.113.200.133` | CA | OVH Hosting, Inc | `EXPLOIT_SCANNER` | 44 | 0.0 MB |
| `195.178.110.241` | AD | Techoff SRV Limited | `EXPLOIT_SCANNER` | 44 | 0.12 MB |
| `203.159.90.217` | NL | 1337 Services GmbH | `HONEYTOKEN_HIT` | 42 | 248.78 MB |
...
| `64.89.163.144` | DE | Meowcore Softworks LLC | `DATABASE_SCANNER` | 30 | 0.0 MB |
...
| `157.15.40.60` | ID | PT Trisari Data Indonesia | `HONEYTOKEN_HIT` | 26 | 0.0 MB |
| `136.66.130.204` | US | Google Cloud (us-west1) | `HONEYTOKEN_HIT` | 24 | 0.01 MB |
| `45.45.237.192` | US | Infraly, LLC | `SPIDER_TRAP_HIT` | 23 | 0.01 MB |
| `78.153.140.156` | GB | HOSTGLOBAL.PLUS LTD | `EXPLOIT_SCANNER` | 22 | 0.0 MB |
| `77.83.39.197` | NL | Lanedonet Datacenter | `EXPLOIT_SCANNER` | 22 | 0.21 MB |
| `100.51.194.111` | US | AWS EC2 (us-east-1) | `HONEYTOKEN_HIT` | 22 | 0.0 MB |
| `94.237.108.164` | NL | Upcloud NL Ams1 | `EXPLOIT_SCANNER` | 20 | 0.02 MB |
| `78.153.140.250` | GB | HOSTGLOBAL.PLUS LTD | `EXPLOIT_SCANNER` | 20 | 0.0 MB |
| `34.224.5.136` | US | AWS EC2 (us-east-1) | `HONEYTOKEN_HIT` | 20 | 0.0 MB |
...
| `93.123.109.178` | AD | Techoff SRV Limited | `HONEYTOKEN_HIT` | 14 | 0.02 MB |
...
| `192.227.176.16` | US | RackNerd LLC | `HONEYTOKEN_HIT` | 12 | 0.03 MB |
...
| `62.141.63.15` | GB | Zentyx Limited | `REDIS_SCANNER` | 10 | 0.0 MB |
...
| `152.32.200.22` | BR | Ucloud Information Technology (hk) Limited | `REDIS_SCANNER` | 10 | 0.0 MB |
...
| `::ffff:52.17.85.134` | IE | AWS EC2 (eu-west-1) | `HONEYTOKEN_HIT` | 8 | 0.01 MB |
| `::ffff:216.180.246.121` | FR |  | `HONEYTOKEN_HIT` | 8 | 0.67 MB |
| `93.216.68.16` | DE | Deutsche Telekom AG | `HONEYTOKEN_HIT` | 8 | 1.56 MB |
| `93.123.109.10` | AD | Techoff SRV Limited | `EXPLOIT_SCANNER` | 8 | 0.01 MB |
...
| `80.94.95.211` | HU | Unmanaged LTD | `EXPLOIT_SCANNER` | 8 | 0.01 MB |
...
| `52.17.85.134` | IE | AWS EC2 (eu-west-1) | `HONEYTOKEN_HIT` | 8 | 0.01 MB |
...
| `45.156.129.80` | US | Inap CHI | `REDIS_SCANNER` | 8 | 0.0 MB |
| `45.131.65.182` | DE | ByteHosting | `HONEYTOKEN_HIT` | 8 | 0.01 MB |
| `44.200.0.224` | US | AWS EC2 (us-east-1) | `HONEYTOKEN_HIT` | 8 | 0.0 MB |
| `43.98.188.22` | SG | Alibaba.com LLC | `HONEYTOKEN_HIT` | 8 | 0.04 MB |
...
| `34.195.125.215` | US | AWS EC2 (us-east-1) | `HONEYTOKEN_HIT` | 8 | 0.0 MB |
...
| `185.242.177.19` | AT | Blue Shield Security GmbH | `HONEYTOKEN_HIT` | 8 | 0.0 MB |
...
| `102.129.152.36` | US | Freedomtech Solutions Limited | `HONEYTOKEN_HIT` | 8 | 0.01 MB |
...
| `::ffff:204.76.203.30` | NL | Intelligence Hosting LLC | `HONEYTOKEN_HIT` | 6 | 0.0 MB |
...
| `34.195.135.127` | US | AWS EC2 (us-east-1) | `HONEYTOKEN_HIT` | 6 | 0.0 MB |
...
| `185.163.156.81` | RU | "BiZone" LLC | `HONEYTOKEN_HIT` | 6 | 0.01 MB |
| `185.148.3.241` | FI | Magnacapax | `HONEYTOKEN_HIT` | 6 | 0.01 MB |
| `185.148.3.232` | FI | Magnacapax | `HONEYTOKEN_HIT` | 6 | 0.01 MB |
| `167.148.112.155` | US | SkyQuantum Internet Service LLC | `HONEYTOKEN_HIT` | 6 | 0.05 MB |
| `158.173.241.11` | SE | VPN Consumer Stockholm, Sweden | `HONEYTOKEN_HIT` | 6 | 0.01 MB |
| `155.2.194.77` | IE | VPN Consumer Dublin, Ireland | `HONEYTOKEN_HIT` | 6 | 0.01 MB |
| `15.235.149.236` | SG | OVH Singapore PTE. LTD | `EXPLOIT_SCANNER` | 6 | 0.06 MB |
| `15.204.146.92` | US | Markiyan, Bulich | `HONEYTOKEN_HIT` | 6 | 0.0 MB |
| `147.185.226.21` | JP |  | `HONEYTOKEN_HIT` | 6 | 0.0 MB |
| `140.228.24.187` | CA |  | `HONEYTOKEN_HIT` | 6 | 0.0 MB |
| `107.172.58.36` | US | RackNerd LLC | `HONEYTOKEN_HIT` | 6 | 0.02 MB |
...
| `::ffff:34.34.103.195` | NL | Google Cloud (europe-west4) | `EXPLOIT_SCANNER` | 4 | 0.0 MB |
...
| `91.90.122.10` | LI | M247 Ltd - Liechtenstein Infra | `HONEYTOKEN_HIT` | 4 | 0.0 MB |
| `82.139.195.194` | DZ | Birkenhauer & Partner GmbH | `HONEYTOKEN_HIT` | 4 | 0.0 MB |
...
| `79.127.129.220` | JP | Cdnext TYO | `EXPLOIT_SCANNER` | 4 | 18.9 MB |
| `78.153.140.252` | GB | HOSTGLOBAL.PLUS LTD | `EXPLOIT_SCANNER` | 4 | 0.0 MB |
| `77.83.39.42` | NL | Lanedonet Datacenter | `EXPLOIT_SCANNER` | 4 | 0.01 MB |
| `65.109.211.195` | FI | Hetzner Online GmbH | `HONEYTOKEN_HIT` | 4 | 0.0 MB |
| `64.89.163.97` | DE | Meowcore Softworks LLC | `DATABASE_SCANNER` | 4 | 0.0 MB |
...
| `34.34.103.195` | NL | Google Cloud (europe-west4) | `EXPLOIT_SCANNER` | 4 | 0.0 MB |
| `34.225.171.109` | US | AWS EC2 (us-east-1) | `HONEYTOKEN_HIT` | 4 | 0.37 MB |
| `34.213.250.221` | US | AWS EC2 (us-west-2) | `HONEYTOKEN_HIT` | 4 | 0.0 MB |
| `3.238.172.251` | US | AWS EC2 (us-east-1) | `HONEYTOKEN_HIT` | 4 | 0.0 MB |
| `23.27.145.89` | US | EGN Dedicated Servers - Asia Optimized | `HONEYTOKEN_HIT` | 4 | 0.0 MB |
| `23.27.145.185` | US | EGN Dedicated Servers - Asia Optimized | `HONEYTOKEN_HIT` | 4 | 0.0 MB |
| `218.78.73.154` | CN | Chinanet SH | `HONEYTOKEN_HIT` | 4 | 0.01 MB |
| `216.73.216.64` | US | Anthropic, PBC | `HONEYTOKEN_HIT` | 4 | 0.04 MB |
| `216.238.69.243` | MX | VULTR-MEXICO | `HONEYTOKEN_HIT` | 4 | 0.0 MB |
...
| `180.93.249.92` | VN | Saigon Postel Corporation | `EXPLOIT_SCANNER` | 4 | 0.0 MB |
...
| `173.239.217.184` | AD | Burnaby Mountain Housing Co-op | `HONEYTOKEN_HIT` | 4 | 0.01 MB |
| `164.92.91.136` | US | DigitalOcean, LLC | `EXPLOIT_SCANNER` | 4 | 3.0 MB |
| `149.102.234.5` | BR | Datacamp Limited | `EXPLOIT_SCANNER` | 4 | 133.42 MB |
...
| `105.157.115.188` | MA |  | `EXPLOIT_SCANNER` | 4 | 0.0 MB |
...
| `71.6.232.29` | US | CariNet, Inc. | `REDIS_SCANNER` | 3 | 0.0 MB |
...
| `45.156.129.82` | US | Inap CHI | `REDIS_SCANNER` | 3 | 0.0 MB |
...
| `185.247.137.157` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 3 | 0.0 MB |
| `185.247.137.147` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 3 | 0.0 MB |
...
| `::ffff:87.236.176.225` | GB | Constantine Cybersecurity LTD | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `::ffff:65.49.1.174` | US | The Shadow Server Foundation | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `::ffff:43.98.188.215` | SG | Alibaba.com LLC | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
| `::ffff:43.98.185.189` | SG | Alibaba.com LLC | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
| `::ffff:207.180.29.33` | US |  | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
...
| `::ffff:185.247.137.165` | GB | Constantine Cybersecurity LTD | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `::ffff:184.105.139.80` | US | The Shadow Server Foundation | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `::ffff:161.8.192.8` | AU |  | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `::ffff:147.185.132.63` | US | Palo Alto Networks, Inc | `HONEYTOKEN_HIT` | 2 | 0.02 MB |
| `::ffff:147.185.132.16` | US | Palo Alto Networks, Inc | `HONEYTOKEN_HIT` | 2 | 0.02 MB |
| `::ffff:147.185.132.144` | US | Palo Alto Networks, Inc | `HONEYTOKEN_HIT` | 2 | 0.02 MB |
| `::ffff:123.12.8.249` | CN |  | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `93.108.200.231` | PT |  | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `91.92.41.151` | BG | Sino Worldwide Trading Limited | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
...
| `87.236.176.169` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 2 | 0.0 MB |
| `87.236.176.163` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 2 | 0.0 MB |
| `87.236.176.147` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 2 | 0.0 MB |
...
| `8.211.37.222` | DE | Alibaba.com Singapore E-Commerce Private Limited | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `79.127.129.231` | JP | Cdnext TYO | `EXPLOIT_SCANNER` | 2 | 5.24 MB |
| `79.127.129.214` | JP | Cdnext TYO | `EXPLOIT_SCANNER` | 2 | 0.18 MB |
| `74.226.208.59` | JP | Microsoft Azure Cloud (japaneast) | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
...
| `64.23.244.101` | US | DigitalOcean, LLC | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
| `64.23.238.222` | US | DigitalOcean, LLC | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `64.23.226.243` | US | DigitalOcean, LLC | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
| `64.23.188.143` | US | DigitalOcean, LLC | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `64.227.161.252` | IN | DigitalOcean, LLC | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
...
| `62.60.217.5` | DE | RTM GmbH | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `62.60.130.230` | IR | UAB Host Baltic | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
| `61.110.5.44` | KR | MOACK | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
...
| `47.89.159.48` | US | ALICLOUD-US | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `47.84.228.159` | SG | Delta Centric LLC, Zenlayer Inc | `EXPLOIT_SCANNER` | 2 | 77.17 MB |
| `47.83.215.78` | HK | IPXO LLC, Zenlayer Inc, Delta Centric LLC | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
| `47.82.65.151` | HK | Alibaba.com LLC | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `47.252.52.82` | US | Alibaba Cloud - US | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `47.237.7.129` | SG | Alibaba.com LLC | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
| `47.237.18.143` | SG | Alibaba.com LLC | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
...
| `46.243.3.58` | NL | NKtelecom INC | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `45.79.207.181` | US | Linode | `REDIS_SCANNER` | 2 | 0.0 MB |
...
| `45.140.222.164` | NL | AI Spera | `DATABASE_SCANNER` | 2 | 0.0 MB |
...
| `43.229.61.53` | AU | Binary Lane PTY LTD | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `40.124.175.197` | US | Microsoft Azure Cloud (southcentralus) | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
...
| `35.189.172.222` | TW | Google Cloud (asia-east1) | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `34.75.78.60` | US | Google Cloud (us-east1) | `EXPLOIT_SCANNER` | 2 | 0.36 MB |
...
| `34.48.92.231` | US | Google Cloud (us-east4) | `EXPLOIT_SCANNER` | 2 | 2.56 MB |
...
| `3.19.29.56` | US | AWS EC2 (us-east-2) | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `23.27.145.215` | US | EGN Dedicated Servers - Asia Optimized | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `23.27.145.213` | US | EGN Dedicated Servers - Asia Optimized | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `23.27.145.191` | US | EGN Dedicated Servers - Asia Optimized | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `23.27.145.189` | US | EGN Dedicated Servers - Asia Optimized | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `23.27.145.188` | US | EGN Dedicated Servers - Asia Optimized | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `23.27.145.14` | US | EGN Dedicated Servers - Asia Optimized | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `23.27.145.121` | US | EGN Dedicated Servers - Asia Optimized | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `23.27.145.102` | US | EGN Dedicated Servers - Asia Optimized | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `23.27.145.10` | US | EGN Dedicated Servers - Asia Optimized | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `23.111.14.188` | SG | Leaseweb Asia Pacific pte. ltd. | `REDIS_SCANNER` | 2 | 0.0 MB |
| `223.247.222.47` | CN | Chinanet AH | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `223.240.118.223` | CN | Chinanet AH | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
...
| `220.197.85.219` | CN |  | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `216.36.105.63` | US | MegaPath Networks Inc. | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `211.145.71.32` | CN | Unicom | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
| `209.97.129.230` | GB | DigitalOcean, LLC | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
| `209.58.160.54` | SG |  | `DATABASE_SCANNER` | 2 | 0.0 MB |
| `209.38.221.33` | DE | Digital Ocean | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
| `206.123.156.179` | GB | Secure Internet LLC | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
| `205.169.39.8` | US | Palo Alto Networks, Inc | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `195.96.139.44` | GB | Constantine Cybersecurity LTD | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `195.96.139.176` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 2 | 0.0 MB |
| `195.96.139.171` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 2 | 0.0 MB |
| `195.96.139.162` | GB | Constantine Cybersecurity LTD | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `195.96.139.160` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 2 | 0.0 MB |
...
| `185.247.137.82` | GB | Constantine Cybersecurity LTD | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `185.247.137.153` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 2 | 0.0 MB |
...
| `185.247.137.119` | GB | Constantine Cybersecurity LTD | `DATABASE_SCANNER` | 2 | 0.0 MB |
...
| `185.242.177.69` | AT | Blue Shield Security GmbH | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `185.242.177.68` | AT | Blue Shield Security GmbH | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `185.242.177.66` | AT | Blue Shield Security GmbH | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `185.242.177.64` | AT | Blue Shield Security GmbH | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `185.242.177.61` | AT | Blue Shield Security GmbH | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `185.242.177.60` | AT | Blue Shield Security GmbH | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `184.69.137.242` | CA | Shaw Communications | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `184.105.139.69` | US | The Shadow Server Foundation | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
| `183.92.113.17` | CN |  | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
| `183.134.40.85` | CN |  | `HONEYTOKEN_HIT` | 2 | 0.17 MB |
...
| `182.138.158.172` | CN | Chinanet SC | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `180.95.238.146` | CN |  | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `18.217.239.9` | US | AWS EC2 (us-east-2) | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `18.181.225.141` | JP | AWS EC2 (ap-northeast-1) | `EXPLOIT_SCANNER` | 2 | 2.62 MB |
| `18.118.100.31` | US | AWS EC2 (us-east-2) | `DATABASE_SCANNER` | 2 | 0.0 MB |
...
| `173.254.210.75` | US | HostPapa | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `173.239.254.94` | US |  | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
| `172.81.101.137` | HK | Hong Kong Communications International Co., Limited | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `172.252.31.96` | US | EGIHosting | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `172.235.211.107` | JP | Akamai Technologies, Inc. | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
...
| `172.233.91.182` | JP | Akamai Technologies, Inc. | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
| `172.233.88.70` | JP | Akamai Technologies, Inc. | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
| `172.203.224.88` | US | Microsoft Azure Cloud (eastus) | `DATABASE_SCANNER` | 2 | 0.0 MB |
...
| `168.110.218.47` | ID | Oracle Corporation | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `167.99.151.186` | US | Digital Ocean | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
| `166.88.121.28` | US | OpenVPN | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `165.154.252.172` | GB | Scloud Pte Ltd | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
...
| `161.35.168.104` | GB | DigitalOcean, LLC | `DATABASE_SCANNER` | 2 | 0.0 MB |
| `161.35.139.2` | US | DigitalOcean, LLC | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `16.146.95.129` | US | AWS EC2 (us-west-2) | `HONEYTOKEN_HIT` | 2 | 0.05 MB |
| `159.65.46.245` | US | Digital Ocean | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `159.223.213.20` | NL | DigitalOcean, LLC | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `158.173.67.60` | BE | VPN Consumer Brussels, Belgium | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `156.236.76.66` | US |  | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `152.42.253.238` | SG | DigitalOcean, LLC | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `152.42.235.126` | SG | DigitalOcean, LLC | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `150.107.74.88` | AU | Mammoth Media Pty Ltd | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `149.57.180.34` | US | LogicWeb Inc | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `149.57.180.20` | US | LogicWeb Inc | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `149.57.180.166` | US | LogicWeb Inc | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `149.57.180.125` | US | LogicWeb Inc | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `149.154.161.219` | NL |  | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `149.154.161.215` | NL |  | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `149.154.161.213` | NL |  | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `149.154.161.196` | NL |  | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `147.45.50.96` | NL | Global Connectivity Solutions LLP | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `147.182.210.9` | US | DigitalOcean, LLC | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
| `146.59.183.16` | FR | Murcia Lamar Richard | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
| `146.190.168.106` | US | DigitalOcean, LLC | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
| `144.31.143.114` | US | Xorek.Cloud Helsinki | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `144.172.96.139` | US | FranTech Solutions | `EXPLOIT_SCANNER` | 2 | 0.04 MB |
| `144.126.222.130` | US | DigitalOcean, LLC | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
...
| `140.238.254.59` | IN | Oracle Cloud Infrastructure (ap-mumbai-1) | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `140.206.194.34` | CN | Unicom SH | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
| `14.29.195.190` | CN | Chinanet GD | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `14.18.95.245` | CN | Chinanet GD | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `139.59.61.219` | IN | DigitalOcean, LLC | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
...
| `138.68.234.154` | US | DigitalOcean, LLC | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `138.197.175.41` | CA | DigitalOcean, LLC | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
| `137.184.79.242` | US | Digital Ocean | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `137.184.182.73` | US | Digital Ocean | `HONEYTOKEN_HIT` | 2 | 0.02 MB |
...
| `13.219.1.233` | US | AWS EC2 (us-east-1) | `DATABASE_SCANNER` | 2 | 0.0 MB |
| `129.227.238.230` | JP | Zenlayer Inc | `EXPLOIT_SCANNER` | 2 | 4.86 MB |
...
| `123.6.49.47` | CN |  | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `122.96.28.19` | CN |  | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
...
| `118.194.253.208` | TW | UCLOUD INFORMATION TECHNOLOGY (HK) LIMITED | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `115.89.98.20` | KR | Boranet | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `110.10.176.24` | KR |  | `HONEYTOKEN_HIT` | 2 | 0.02 MB |
...
| `106.117.111.189` | CN | Chinanet HE | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `104.43.131.157` | US | Microsoft Azure Cloud (centralus) | `EXPLOIT_SCANNER` | 2 | 0.01 MB |
| `104.28.163.29` | SG | Cloudflare WARP | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
| `104.28.163.18` | SG | Cloudflare WARP | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
| `104.251.181.72` | CH | SKN & Telecom Ltd | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
| `104.131.118.152` | US | Digital Ocean | `HONEYTOKEN_HIT` | 2 | 0.01 MB |
| `103.4.249.4` | US | UAB code200 | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `103.236.163.77` | AU | Ausgamers Pty Ltd | `EXPLOIT_SCANNER` | 2 | 0.01 MB |
...
| `94.231.206.3` | CN |  | `DATABASE_SCANNER` | 1 | 0.0 MB |
...
| `94.231.206.14` | CN |  | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `94.231.206.135` | CN |  | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `94.231.206.12` | CN |  | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `94.231.206.1` | CN |  | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `91.238.181.94` | FR | ThinkTech Technology Industrial CO. Limited | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `91.231.89.135` | FR | ONYPHE | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `91.231.89.134` | FR | ONYPHE | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `91.231.89.131` | FR | ONYPHE | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `91.231.89.13` | FR | ONYPHE | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `89.37.172.156` | GB | Infrawatch Limited | `DATABASE_SCANNER` | 1 | 0.0 MB |
...
| `87.236.176.173` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
| `87.236.176.171` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
| `87.236.176.166` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
| `87.236.176.165` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
| `87.236.176.161` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
| `87.236.176.159` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
| `87.236.176.153` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
| `87.236.176.152` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
| `87.236.176.150` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
| `87.236.176.149` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
...
| `81.19.216.83` | NL | Infrawatch Limited | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `81.19.216.103` | NL | Infrawatch Limited | `REDIS_SCANNER` | 1 | 0.0 MB |
| `80.82.77.202` | NL | IP Volume inc | `REDIS_SCANNER` | 1 | 0.0 MB |
| `8.231.138.73` | US | Google Cloud (us-west1) | `DATACENTER` | 1 | 19.0 MB |
| `8.134.159.4` | CN | Alibaba.com LLC | `REDIS_SCANNER` | 1 | 0.0 MB |
...
| `66.132.186.159` | US | Censys, Inc | `DATABASE_SCANNER` | 1 | 0.0 MB |
...
| `66.132.172.138` | US | Censys Inc | `DATABASE_SCANNER` | 1 | 0.0 MB |
...
| `64.89.163.152` | DE | Meowcore Softworks LLC | `DATABASE_SCANNER` | 1 | 0.0 MB |
...
| `52.224.241.44` | US | Microsoft Azure Cloud (eastus) | `REDIS_SCANNER` | 1 | 0.0 MB |
| `5.226.140.9` | GB | Infrawatch Limited | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `5.226.140.57` | GB | Infrawatch Limited | `REDIS_SCANNER` | 1 | 0.0 MB |
| `5.226.140.10` | GB | Infrawatch Limited | `DATABASE_SCANNER` | 1 | 0.0 MB |
...
| `47.116.44.56` | CN | Alibaba.com LLC | `REDIS_SCANNER` | 1 | 0.0 MB |
| `45.82.78.107` | SG | Detai Prosperous Technologies Limited | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `45.79.211.97` | US | Linode | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `45.227.254.152` | LT | Xwin Universal LTD | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `45.156.129.83` | US | Inap CHI | `REDIS_SCANNER` | 1 | 0.0 MB |
| `45.156.129.81` | US | Inap CHI | `REDIS_SCANNER` | 1 | 0.0 MB |
| `45.142.154.106` | HK | Allcloud US | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `45.140.222.166` | NL | AI Spera | `REDIS_SCANNER` | 1 | 0.0 MB |
| `44.220.185.109` | US | AWS EC2 (us-east-1) | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `43.248.108.152` | CN |  | `DATABASE_SCANNER` | 1 | 0.0 MB |
...
| `40.124.178.49` | US | Microsoft Azure Cloud (southcentralus) | `DATABASE_SCANNER` | 1 | 0.0 MB |
...
| `35.205.162.235` | BE | Google Cloud (europe-west1) | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `35.195.132.199` | BE | Google Cloud (europe-west1) | `DATABASE_SCANNER` | 1 | 0.0 MB |
...
| `34.156.20.136` | BE | Google Cloud (europe-west1) | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `34.140.126.150` | BE | Google Cloud (europe-west1) | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `34.14.112.72` | BE | Google Cloud (europe-west1) | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `34.127.118.148` | US | Google Cloud (us-west1) | `DATACENTER` | 1 | 19.0 MB |
| `31.14.32.8` | NL | Modat | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `31.14.32.6` | NL | Modat | `REDIS_SCANNER` | 1 | 0.0 MB |
...
| `216.226.77.20` | GB | Valence Technology Co | `REDIS_SCANNER` | 1 | 0.0 MB |
| `205.210.31.87` | US | Palo Alto Networks, Inc | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `20.83.48.204` | US | Microsoft Azure Cloud (centralus) | `REDIS_SCANNER` | 1 | 0.0 MB |
| `20.221.69.50` | US | Microsoft Azure Cloud (centralus) | `REDIS_SCANNER` | 1 | 0.0 MB |
...
| `198.235.24.84` | US | Palo Alto Networks, Inc | `REDIS_SCANNER` | 1 | 0.0 MB |
...
| `195.96.139.181` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
| `195.96.139.177` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
| `195.96.139.173` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
| `195.96.139.158` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
| `195.96.139.156` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
| `195.96.139.146` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
...
| `188.240.59.34` | GB | Infrawatch Limited | `REDIS_SCANNER` | 1 | 0.0 MB |
| `185.247.137.179` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
| `185.247.137.178` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
| `185.247.137.176` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
| `185.247.137.155` | GB | Constantine Cybersecurity LTD | `REDIS_SCANNER` | 1 | 0.0 MB |
...
| `185.223.235.14` | NL | Infrawatch Limited | `REDIS_SCANNER` | 1 | 0.0 MB |
| `185.216.145.164` | GB | Infrawatch Limited | `REDIS_SCANNER` | 1 | 0.0 MB |
| `185.107.80.93` | NL | NForce Entertainment B.V | `REDIS_SCANNER` | 1 | 0.0 MB |
...
| `173.255.221.189` | US | Linode | `DATABASE_SCANNER` | 1 | 0.0 MB |
...
| `169.239.183.229` | ZA |  | `EXPLOIT_SCANNER` | 1 | 0.0 MB |
| `169.150.201.9` | DE | Cdnext FRA | `EXPLOIT_SCANNER` | 1 | 0.0 MB |
| `167.94.146.61` | DE | Censys, Inc. | `DATABASE_SCANNER` | 1 | 0.0 MB |
...
| `147.185.132.73` | US | Palo Alto Networks, Inc | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `147.185.132.55` | US | Palo Alto Networks, Inc | `REDIS_SCANNER` | 1 | 0.0 MB |
| `147.185.132.54` | US | Palo Alto Networks, Inc | `REDIS_SCANNER` | 1 | 0.0 MB |
| `147.185.132.103` | US | Palo Alto Networks, Inc | `DATABASE_SCANNER` | 1 | 0.0 MB |
| `147.185.132.100` | US | Palo Alto Networks, Inc | `DATABASE_SCANNER` | 1 | 0.0 MB |
