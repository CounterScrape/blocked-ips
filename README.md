...
## 📊 Live Metrics
* **Total Unique IPs Blocked:** `524`
* **Total Bandwidth Consumed:** `9435 MB` (~9.21 GB)
...
| :--- | :---: | :--- | :--- | :---: | :---: |
| `213.209.159.115` | DE | Feo Prest SRL | `DATABASE_SCANNER` | 6393 | 0.0 MB |
| `213.209.159.154` | DE | Feo Prest SRL | `DATABASE_SCANNER` | 1688 | 0.0 MB |
| `2a06:98c0:3600::103` | US | Cloudflare, Inc. | `EXPLOIT_SCANNER` | 777 | 31.52 MB |
...
| `::ffff:45.148.10.200` | NL | Techoff SRV Limited | `EXPLOIT_SCANNER` | 91 | 0.0 MB |
...
| `unknown` | ?? | unknown | `DATABASE_SCANNER` | 37 | 0.0 MB |
| `203.159.90.218` | NL | 1337 Services GmbH | `HONEYTOKEN_HIT` | 35 | 76.91 MB |
...
| `157.15.40.60` | ID | PT Trisari Data Indonesia | `HONEYTOKEN_HIT` | 18 | 0.0 MB |
...
| `203.159.90.217` | NL | 1337 Services GmbH | `HONEYTOKEN_HIT` | 12 | 37.78 MB |
...
| `62.141.63.15` | GB | Zentyx Limited | `REDIS_SCANNER` | 5 | 0.0 MB |
| `3.129.187.38` | US | AWS EC2 (us-east-2) | `REDIS_SCANNER` | 5 | 0.0 MB |
...
| `45.92.84.250` | KZ | HostRoyale Technologies | `HONEYTOKEN_HIT` | 4 | 0.0 MB |
...
| `78.153.140.252` | GB | HOSTGLOBAL.PLUS LTD | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
...
| `45.92.87.171` | KZ | HostRoyale Technologies | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `45.92.85.225` | KZ | HostRoyale Technologies | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `45.198.224.96` | SE | Vpsvault.host LTD | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
...
| `213.209.159.175` | DE | Feo Prest SRL | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
...
| `195.96.139.122` | GB | Constantine Cybersecurity LTD | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `15.235.149.236` | SG | OVH Singapore PTE. LTD | `EXPLOIT_SCANNER` | 2 | 0.03 MB |
...
| `5.101.64.6` | RU | PIN DC | `DATABASE_SCANNER` | 1 | 0.0 MB |
...
| `47.84.228.159` | SG | Delta Centric LLC, Zenlayer Inc | `EXPLOIT_SCANNER` | 1 | 0.0 MB |
...
| `192.253.248.180` | GB | Secure Internet LLC | `DATABASE_SCANNER` | 1 | 0.0 MB |
