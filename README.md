...
| `::ffff:216.180.246.121` | ?? | spoofed-browser-header-mismatch | `HONEYTOKEN_HIT` | 8 | 0.67 MB |
| `148.113.205.188` | ?? | unknown | `unknown` | 8 | 176.0 MB |
| `65.21.124.77` | ?? | unknown | `unknown` | 5 | 110.0 MB |
| `203.159.90.218` | ?? | unknown | `HONEYTOKEN_HIT` | 5 | 1.13 MB |
| `45.92.85.110` | ?? | spoofed-browser-header-mismatch | `HONEYTOKEN_HIT` | 4 | 0.0 MB |
| `216.73.216.64` | US | Anthropic, PBC | `HONEYTOKEN_HIT` | 4 | 0.04 MB |
| `193.32.162.60` | ?? | spoofed-browser-header-mismatch | `EXPLOIT_SCANNER` | 4 | 0.0 MB |
...
| `45.92.86.172` | ?? | spoofed-browser-header-mismatch | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `45.92.86.171` | ?? | spoofed-browser-header-mismatch | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `45.92.86.162` | ?? | spoofed-browser-header-mismatch | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `45.92.85.244` | ?? | spoofed-browser-header-mismatch | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `45.92.84.87` | ?? | spoofed-browser-header-mismatch | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `45.92.84.56` | ?? | spoofed-browser-header-mismatch | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `45.92.84.52` | ?? | spoofed-browser-header-mismatch | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `45.92.84.167` | ?? | spoofed-browser-header-mismatch | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `45.92.84.0` | ?? | spoofed-browser-header-mismatch | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
| `45.45.237.214` | ?? | unknown | `unknown` | 2 | 39.0 MB |
| `45.130.203.179` | DZ | Algiers | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `198.51.100.91` | ?? | unknown | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `134.209.178.19` | ?? | unknown | `HONEYTOKEN_HIT` | 2 | 0.0 MB |
...
| `62.141.63.15` | ?? | unknown | `REDIS_SCANNER` | 1 | 0.0 MB |
...
| `43.135.144.126` | ?? | spider-trap-active-containment | `SPIDER_TRAP_HIT` | 1 | 0.0 MB |
...
| `164.92.91.136` | ?? | unknown | `EXPLOIT_SCANNER` | 1 | 0.0 MB |
