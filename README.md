...
## 📊 Live Metrics
* **Total Unique IPs Blocked:** `538`
* **Total Bandwidth Consumed:** `9439 MB` (~9.22 GB)
...
| `2a06:98c0:3600::103` | US | Cloudflare, Inc. | `EXPLOIT_SCANNER` | 865 | 35.13 MB |
...
| `unknown` | ?? | unknown | `DATABASE_SCANNER` | 41 | 0.0 MB |
