...
## 📊 Live Metrics
* **Total Unique IPs Blocked:** `497`
* **Total Bandwidth Consumed:** `9430 MB` (~9.21 GB)
...
| `2a06:98c0:3600::103` | US | Cloudflare, Inc. | `EXPLOIT_SCANNER` | 645 | 26.11 MB |
...
| `203.159.90.218` | NL | 1337 Services GmbH | `HONEYTOKEN_HIT` | 32 | 76.91 MB |
