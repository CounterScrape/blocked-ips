...
## 📊 Live Metrics
* **Total Unique IPs Blocked:** `90`
* **Total Bandwidth Consumed:** `9152 MB` (~8.94 GB)
...
| `2a06:98c0:3600::103` | ?? | unknown | `EXPLOIT_SCANNER` | 47 | 1.51 MB |
| `94.237.108.164` | ?? | spoofed-browser-header-mismatch | `EXPLOIT_SCANNER` | 20 | 0.02 MB |
| `41.143.185.23` | ?? | unknown | `HONEYTOKEN_HIT` | 12 | 0.0 MB |
| `92.222.9.185` | FR | OVH SAS | `DATACENTER` | 10 | 8018.0 MB |
| `144.172.116.30` | ?? | 30.116.172.144.static.cloudzy.com | `EXPLOIT_SCANNER` | 10 | 0.02 MB |
| `148.113.205.188` | CA | OVH Hosting, Inc | `DATACENTER` | 8 | 176.0 MB |
| `62.60.130.227` | ?? | spoofed-browser-header-mismatch | `HONEYTOKEN_HIT` | 6 | 0.0 MB |
| `65.21.124.77` | FI | Hetzner | `DATACENTER` | 5 | 110.0 MB |
| `216.73.216.64` | ?? | spoofed-browser-header-mismatch | `HONEYTOKEN_HIT` | 4 | 0.04 MB |
| `203.159.90.218` | ?? | unknown | `HONEYTOKEN_HIT` | 4 | 1.13 MB |
| `193.32.162.60` | ?? | spoofed-browser-header-mismatch | `EXPLOIT_SCANNER` | 4 | 0.0 MB |
| `80.94.95.211` | ?? | unknown | `EXPLOIT_SCANNER` | 2 | 0.0 MB |
...
| `203.159.90.217` | ?? | dns.google | `HONEYTOKEN_HIT` | 2 | 1.07 MB |
