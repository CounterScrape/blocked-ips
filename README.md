...
| :--- | :---: | :--- | :--- | :---: | :---: |
| `213.209.159.115` | DE | Feo Prest SRL | `DATABASE_SCANNER` | 5544 | 0.0 MB |
...
| `2a06:98c0:3600::103` | US | Cloudflare, Inc. | `EXPLOIT_SCANNER` | 669 | 27.09 MB |
...
| `unknown` | ?? | unknown | `DATABASE_SCANNER` | 33 | 0.0 MB |
